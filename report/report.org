...
** Header
	...
	[[./images/voyify-transparent.png]]

	Account button change after logging in:
	[[./images/account_button.png]]
	[[./images/denis_button.png]]

** Account
   Account page can be in one of two states: registration/login state or logged in state, where user's history can be examined.
   	registerSubmit(e)
	loginSubmit(e)
	deleteAccount()
	getHistory()
